...
var block1 = []
			.concat(items.subset("syllNum","1").subset("fric","yes").chooseRandom(2))
			.concat(items.subset("syllNum","1").subset("fric","no").chooseRandom(2))
			.concat(items.subset("syllNum","2").subset("fric","yes").chooseRandom(2))
	                .concat(items.subset("syllNum","2").subset("fric","no").chooseRandom(2))
			.pairWith("view","stimulus.ejs")
			.shuffle()
    	                .pairWith("order",1)
		//	.pairWith("order",[1,2])
...
var sampleItem = items.subset("syllNum","1").chooseRandom(2)
			.pairWith("order",1)
			.pairWith("view","stimulus.ejs")
			;
