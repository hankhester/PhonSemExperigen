Experigen.initialize = function () {
  console.log("Experiment type: phonology\nSemantic salience: animacy");
   ...
   if(heads == 0){
    var blockTrain = [].concat(items.subset("syllNum","1").subset("fric","yes").choose(5)
			       .pairWith("frame",pictures.subset("animate","yes").choose(5))
			       .pairWith("view","stimulusTest2.ejs"),

			        items.subset("syllNum","1").subset("fric","no").choose(5)
			       .pairWith("frame",pictures.subset("animate","yes").chooseNext(5,10))
			       .pairWith("view","stimulusTest2.ejs"),

			       items.subset("syllNum","1").subset("fric","yes").chooseNext(5,10)
			       .pairWith("frame",pictures.subset("animate","no").choose(5))
			       .pairWith("view","stimulusTest2.ejs"),

			       items.subset("syllNum","1").subset("fric","no").chooseNext(5,10)
			       .pairWith("frame",pictures.subset("animate","no").chooseNext(5,10))
			       .pairWith("view","stimulusTest2.ejs"),
			       ...
			       .pairWith("frame",pictures.subset("animate","yes").chooseNext(15,20))
			       .pairWith("view","stimulusTest.ejs")
			  ).shuffle();
   }
    else if(heads == 1) {
