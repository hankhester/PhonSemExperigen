...
experigen.sourceURL = "www.unc.edu.linguistics.concept.phonSem.web.index5.html" 
# the following information comes from your settings.js file:
experigen.experimentName = "PhonSyllShape"
...
write.csv(xp, "~/Documents/KatyaWork/xp.csv")
